...
```{r doc_setup_12, echo=FALSE, message=FALSE}
library(tidyverse)
```
...
```{r}
# Example 1: different string, start, and end
string_data <- tibble(
...
# Example 2: fixed string, different start and end
string_data2 <- tibble(
    start = c(1, 2, 4),
    end = c(2, 3, 5)
)
pmap_chr(string_data2, str_sub, string = "abcde")
```
